import "https://cdn.tiny.cloud/1/s8googw8n9fva3do0982r0f6ltgvwmr42p68pt5o8kerc7qi/tinymce/7/tinymce.min.js";
...
document.addEventListener("DOMContentLoaded", function () {
    tinymce.init({
        ...
        toolbar: [
            "help print searchreplace | accordion accordionremove | undo redo removeformat | blocks fontfamily  fontsizeinput lineheight | bold italic underline strikethrough subscript superscript blockquote | forecolor backcolor | Image media link | alignleft aligncenter alignright alignjustify bullist numlist | lineheight outdent indent | charmap emoticons language | table pagebreak anchor visualchars codesample code tiny_mce_wiris_formulaEditor tiny_mce_wiris_formulaEditorChemistry preview | customInsertButton",
        ],
