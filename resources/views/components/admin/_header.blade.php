        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-notifications-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="" id="notifications-dot"></span>
                </button>
                <div class="p-0 dropdown-menu dropdown-menu-lg dropdown-menu-right" aria-labelledby="page-header-notifications-dropdown">
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="javascript:void(0)" id="mark-all-notifications-as-read" class="small"> Mark all as read</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <div class="" id="container-notifications-list">
                            <a class="p-3 text-center text-muted">
                    ...
                    <div class="p-2 border-top">
                        <a class="text-center btn btn-sm btn-link font-size-14 btn-block" href="#">
