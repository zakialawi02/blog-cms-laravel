...
@section("title", "Posts in " . date("F", strtotime(request()->segment(3) . "-" . request()->segment(4) . "-01")) . " | zakialawi")
@section("meta_description", "Archive of all posts of " . date("F", strtotime(request()->segment(3) . "-" . request()->segment(4) . "-01")) . " on the zakialawi.my.id website")
@section("meta_author", "zakialawi")

@section("og_title", "Posts in " . date("F", strtotime(request()->segment(3) . "-" . request()->segment(4) . "-01")) . " | zakialawi.my.id")
@section("og_description", "Archive of all posts of " . date("F", strtotime(request()->segment(3) . "-" . request()->segment(4) . "-01")) . " on the zakialawi.my.id website")
    ...
    <main class="w-full">
        ...
        <section class="container px-6 py-10 md:px-4">
            <div class="mb-6 text-3xl font-semibold">
                <h2>
                    {{ request()->has("search") && request()->get("search") != "" ? "Search Result" : "Archive: " . date("F", strtotime(request()->segment(3) . "-" . request()->segment(4) . "-01")) . " " . request()->segment(3) }}
                </h2>
