...
@section("title", "Posts by tag of " . request()->segment(3) . " | zakialawi")
@section("meta_description", "Blog Posts by tag of " . request()->segment(3) . " on the zakialawi.my.id website")
@section("meta_author", "zakialawi")

@section("og_title", "Posts by tag of " . request()->segment(3) . " | zakialawi.my.id")
@section("og_description", "Blog Posts by tag of " . request()->segment(3) . " on the zakialawi.my.id website")
